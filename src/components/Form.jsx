export default function Form({newName, handleChange, addNewName}){
    return(
        <>
            <input type="text" onChange={handleChange} className="text-input" id="text" />
            <button onClick={()=>addNewName(newName)}>Invia</button>
